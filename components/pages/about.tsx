                  ...
                  <div className="sticky top-10">
                    ...
                    <div className="flex flex-col text-center gap-y-4">
                      <div className="flex items-center gap-x-3">
                        <a
                          href="https://docs.google.com/viewer?url=https://docs.google.com/document/d/1vfEh5E1RyFzNHWi-lvxLmFN7aGR2CR4iHGaz89NGRs0/export?format=pdf"
                          rel="ajay"
                          target="_blank"
                        ...
                        <a
                          href="https://docs.google.com/document/d/1vfEh5E1RyFzNHWi-lvxLmFN7aGR2CR4iHGaz89NGRs0/export?format=pdf"
