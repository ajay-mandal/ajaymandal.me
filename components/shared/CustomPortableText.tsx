...
export const CustomPortableText: PortableTextComponents = {
  ...
  block: {
    ...
    blockquote: ({ children }) => (
      <blockquote className="relative overflow-hidden tracking-tight text-lg my-8 lg:py-6 lg:pl-6 pr-12 p-4 border border-zinc-800  rounded-md">
        <BiSolidQuoteRight
  ...
  marks: {
    em: ({ children }) => (
      <em className="font-incognito font-semibold text-primary-color">
        {children}
      </em>
    ),
    strong: ({ children }) => (
    ...
    code: ({ children }) => (
      <code className="font-incognito py-[0.15rem] px-1 rounded-sm font-medium bg-primary-bg  text-zinc-200">
        {children}
      </code>
    ),
  },
